...
class BattleNetInfoTest < Test::Unit::TestCase
  ...
  def test_raising_exception_while_download_profile_content
    not_a_player = BattleNetInfo.new('http://eu.battle.net/sc2/en/profile/267901/1/InvalidProfile/')
    assert_raise ProfileNotFound do
      not_a_player.race
    end
  ...
  def test_getting_player_stats
    ...
    assert_equal 1247, points
    assert_equal 860, wins
